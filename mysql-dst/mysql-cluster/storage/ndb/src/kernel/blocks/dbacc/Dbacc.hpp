...
private:
  ...
  // DST's additional signal handler
  void execACC_COMMITDST(Signal* signal);
...
void insertLockOwnersList(const OperationrecPtr&,uint64_t ts = 0) const;
