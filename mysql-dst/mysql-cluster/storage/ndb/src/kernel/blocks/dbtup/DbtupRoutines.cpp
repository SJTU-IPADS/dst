...
int Dbtup::readAttributes(KeyReqStruct *req_struct,
                          ...
                          bool    xfrm_flag)
{
  //RDMA_LOG(3) << "DbtupRoutines: read Attributes";
  ...
  //RDMA_LOG(1) << "read num attributes " << numAttributes;
